...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Passport Legend protects your privacy and handles your personal information with the highest standards of security.",
};
    ...
    <div className="flex min-h-screen flex-col bg-white dark:bg-neutral-950">
      ...
      <main className="flex-grow pt-24 pb-20 md:pt-32">
        ...
        <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary-500-500/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="glass p-8 md:p-10 rounded-3xl mb-16 border-primary-100/20 animate-fade-in-up">
              <p className="text-lg md:text-xl text-neutral-700 dark:text-neutral-300 leading-relaxed italic">
                ...
                bring to securing your global future."
              </p>
            </div>
            ...
            <div className="space-y-16">
              ...
              <section className="group">
                <div className="flex items-start gap-4 md:gap-6">
                  <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-primary-500-600 text-white flex items-center justify-center shadow-premium group-hover:scale-110 transition-transform">
                  ...
                  <div>
                    ...
                    <div className="text-neutral-600 dark:text-neutral-400 space-y-3">
                      <p>
                        ...
                        with full transparency and compliance with international
                    ...
                    <div className="text-neutral-600 dark:text-neutral-400 space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 shadow-sm">
                          ...
                          <p className="text-sm">
                            Information you give us, such as your name, email
                            address, and phone number when you inquire about our
                            services.
                          </p>
                        </div>
                        <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 shadow-sm">
                          ...
                          <p className="text-sm">
                            Usage data, IP addresses, and information collected
                            through trackers and cookies to improve site
                            performance.
                          </p>
                        </div>
                      </div>
              ...
              <section className="group">
                <div className="flex items-start gap-4 md:gap-6">
                  <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-primary-500-700 text-white flex items-center justify-center shadow-premium group-hover:scale-110 transition-transform">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        ...
                        },
                        {
                          ...
                          desc: "You can request that we delete your personal information.",
                        },
                        {
                          title: "Right to Correct",
                          desc: "You can ask us to update or correct inaccurate data.",
                        },
                        {
                          title: "Right to Object",
                          desc: "You have the right to object to our processing of your data.",
                        },
                      ].map((right, i) => (
                        <div
                          key={i}
                          className="p-5 rounded-2xl border border-neutral-100 dark:border-neutral-800 hover:border-accent-500/50 transition-colors"
                        >
              ...
              <section className="mt-20">
                <div className="relative overflow-hidden rounded-[2rem] bg-primary-500-600 p-8 md:p-12 text-white">
                  ...
                  <div className="relative z-10 text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-primary-100 mb-8 text-lg">
                      Our privacy team is dedicated to ensuring your data
                      remains secure. If you have any questions or wish to
