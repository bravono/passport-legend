...
export const metadata: Metadata = {
  ...
  description:
    "Read our terms of service to understand your rights and responsibilities when using Passport Legend's global citizenship and residency services.",
};
  ...
  const sections = [
    {
      ...
      content:
        "By accessing or using the Passport Legend website and services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.",
      color: "bg-primary-500-600",
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "2. Description of Services",
      content:
        "Passport Legend provides information, advisory services, and consultation regarding global citizenship and residence by investment programs. Our services are designed to assist clients in navigating complex international migration paths.",
      color: "bg-accent-600",
    },
    {
      ...
      content:
        "Users are responsible for providing accurate and complete information during consultations. Any misuse of our platform, including the submission of fraudulent documents or unauthorized access to our systems, is strictly prohibited.",
    ...
    },
    {
      ...
      content:
        "While we strive for accuracy, the information on this website is for general informational purposes only and does not constitute legal, financial, or tax advice. We recommend consulting with qualified professionals for specific legal or financial decisions.",
      color: "bg-primary-500-700",
    },
    {
      icon: <Gavel className="w-6 h-6" />,
      title: "5. Intellectual Property",
      content:
        "All content, logos, designs, and materials on this website are the intellectual property of Passport Legend. Unauthorized reproduction, distribution, or modification of any content is strictly prohibited without prior written consent.",
      color: "bg-accent-700",
    },
    {
      ...
      content:
        "Passport Legend shall not be liable for any indirect, incidental, or consequential damages arising out of the use or inability to use our services. Our total liability is limited to the extent permitted by law.",
    ...
    },
    {
      ...
      content:
        "These terms and conditions are governed by and construed in accordance with the laws of the United Kingdom. Any disputes relating to these terms will be subject to the exclusive jurisdiction of the courts of England and Wales.",
    ...
    <div className="flex min-h-screen flex-col bg-white dark:bg-neutral-950">
      ...
      <main className="flex-grow pt-24 pb-20 md:pt-32">
        ...
        <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
          <div className="absolute top-[10%] left-[10%] w-[600px] h-[600px] bg-primary-500-500/5 rounded-full blur-[120px]" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="glass p-8 md:p-10 rounded-3xl mb-16 border-accent-100/20 animate-fade-in-up">
              <p className="text-lg text-primary-500/80 dark:text-neutral-300 leading-relaxed italic">
                ...
                excellence and transparency in return."
              </p>
            </div>
              ...
              {sections.map((section, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row gap-6 relative z-10">
                    <div
                      className={`flex-shrink-0 w-12 h-12 rounded-2xl ${section.color} text-white flex items-center justify-center shadow-premium group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                    >
                      {section.icon}
                    </div>
            ...
            <section className="relative overflow-hidden rounded-[2rem] bg-neutral-900 p-8 md:p-12 text-white">
              {/* Background Glow */}
              <div className="absolute top-0 right-0 w-80 h-80 bg-primary-500-600/20 rounded-full -mr-40 -mt-40 blur-3xl" />
              ...
              <div className="relative z-10 text-center max-w-2xl mx-auto">
                ...
                <p className="text-neutral-400 mb-8 text-lg">
                  ...
                  our legal practices, please reach out to our legal department.
                </p>
