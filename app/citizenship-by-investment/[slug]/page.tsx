            ...
            >
              <Container>
                <div className="text-center max-w-3xl mx-auto mb-20">
                  ...
                  <p className="text-lg text-neutral-600 dark:text-neutral-400 font-light">
                    A transparent and streamlined journey toward your second
                    citizenship.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="order-1 md:order-2">
                    ...
                    <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-10 font-light">
                      To qualify for the {country.name} Citizenship by
                      Investment Program, applicants must meet the following
                      core requirements:
                    </p>
