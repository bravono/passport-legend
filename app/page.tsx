...
import { citizenshipCountries, residenceCountries, processSteps, faqs, blogPosts } from "@/lib/data/home-page";
    ...
    <>
      ...
      <main className="overflow-hidden">
        ...
        <Section className="relative min-h-[90vh] flex items-center bg-white">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1512453979798-5ea266f8880c?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-10" />
          ...
          <Container className="relative z-10">
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="space-y-8 animate-fade-in-up">
                ...
                <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] text-primary-900">
                  ...
                  <span className="text-gradient">{" "}
                    Gateway to Global Freedom</span>
                </h1>
              ...
              <div className="relative hidden lg:block">
                ...
                <img 
                  src="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=2070&q=80" 
        ...
        <Section className="bg-primary-900 text-white relative py-24 overflow-hidden">
              ...
              {[
                {
                  name: "John Smith",
                  role: "Entrepreneur",
                  content: "Passport Legend made my citizenship dream a reality. The process was seamless from start to finish.",
                },
                {
                  name: "Maria Garcia",
                  role: "Real Estate Investor",
                  content: "Professional, transparent, and incredibly supportive. Their guidance on the Golden Visa was invaluable.",
                },
                {
                  name: "David Chen",
                  role: "Business Owner",
                  content: "The team went above and beyond to ensure my family's security. Best decision we've made.",
                },
              ].map((testimonial, i) => (
                <Card key={i} className="bg-primary-800/50 border-primary-700/50 backdrop-blur-sm p-8">
          ...
          <Container>
            <div className="text-center mb-16 space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-900">
                Residence <span className="italic text-accent-600">Opportunities</span>
              </h2>
              <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
                Secure your right to live, work, and study in the world's most desirable jurisdictions.
              </p>
              <div className="h-1 w-24 bg-accent-500 mx-auto rounded-full" />
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {residenceCountries.map((country, i) => (
                <Link key={i} href={`/residence-by-investment/${country.slug}`}>
                  <Card hover className="p-0 overflow-hidden group h-full flex flex-col border-neutral-100 shadow-sm hover:shadow-premium transition-all">
                    ...
                    <div className="p-6 flex-grow flex flex-col justify-between">
                      <ul className="space-y-3 mb-6">
                        {country.facts.map((fact, j) => (
                          <li key={j} className="flex items-center gap-3 text-neutral-600">
                      ...
                      <div className="flex items-center gap-2 text-primary-600 font-bold group-hover:text-primary-700">
                        Explore Program <ArrowRight size={18} className="transition-transform group-hover:translate-x-2" />
                      </div>
                    </div>
                  </Card>
                </Link>
          ...
          <Container>
            <div className="text-center mb-16 space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-white">
                Citizenship <span className="italic text-accent-400">Opportunities</span>
              </h2>
              <p className="text-xl text-primary-100 max-w-2xl mx-auto">
                Obtain a powerful second passport and enjoy visa-free travel to over 150 countries.
              </p>
              <div className="h-1 w-24 bg-accent-500 mx-auto rounded-full" />
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {citizenshipCountries.map((country, i) => (
                <Link key={i} href={`/citizenship-by-investment/${country.slug}`}>
                  <Card hover className="bg-primary-800/30 border-primary-700/50 p-0 overflow-hidden group h-full flex flex-col shadow-sm hover:shadow-premium-hover transition-all">
                    <div className="relative h-64 overflow-hidden">
                      <img 
                        src={country.image} 
                        alt={country.name} 
                    ...
                    <div className="p-6 flex-grow flex flex-col justify-between">
                      <ul className="space-y-3 mb-6">
                        {country.facts.map((fact, j) => (
                          <li key={j} className="flex items-center gap-3 text-primary-100">
        ...
        <Section className="bg-white">
          <Container>
            <div className="text-center mb-20 space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-900">Our Process</h2>
              <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
            ...
            <div className="max-w-5xl mx-auto space-y-16 md:space-y-24 relative">
              ...
              {processSteps.map((step, i) => {
                const isLeft = i % 2 === 0;
                return (
                  <div key={i} className={`relative flex flex-col md:flex-row items-center gap-8 md:gap-16 ${isLeft ? '' : 'md:flex-row-reverse'}`}>
                    {/* Content Card */}
                    <div className={`flex-1 group ${isLeft ? 'md:text-right' : 'md:text-left'}`}>
                      <div className={`p-8 md:p-10 rounded-3xl border border-accent-300/40 bg-gradient-to-br from-accent-500 to-accent-600 shadow-lg hover:shadow-premium-hover transition-all duration-500 ${isLeft ? 'md:ml-auto' : 'md:mr-auto'} max-w-lg`}>
                        ...
                        <p className={`text-white/90 leading-relaxed text-sm ${isLeft ? 'md:text-right' : 'md:text-left'}`}>
                          {step.description}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative z-10 shrink-0 order-first md:order-none">
                      <div className="h-16 w-16 rounded-full bg-gradient-to-br from-primary-600 to-primary-800 shadow-xl flex items-center justify-center border-4 border-white">
        ...
        <Section className="bg-primary-900 text-white overflow-hidden py-24">
          <Container>
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              <div className="space-y-4">
                <h2 className="text-4xl font-bold">Latest Insights</h2>
                <p className="text-primary-100 max-w-xl">Stay updated with the latest trends and changes in the investment migration industry.</p>
              </div>
              <Button variant="outline" className="border-accent-500/30 text-accent-400 hover:bg-accent-500/10" asChild>
            ...
            <div className="flex gap-8 overflow-x-auto pb-8 snap-x no-scrollbar">
              {blogPosts.map((post, i) => (
                <div key={i} className="min-w-[300px] md:min-w-[400px] snap-start group">
                  <Link href={post.link}>
        ...
        <Section className="bg-white">
          <Container>
            <div className="text-center mb-16 space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-900">Frequently Asked Questions</h2>
              <div className="h-1 w-24 bg-accent-500 mx-auto rounded-full" />
            </div>

            <div className="max-w-4xl mx-auto grid gap-6">
              {faqs.map((faq, i) => (
                <details key={i} className="group border border-neutral-100 rounded-3xl overflow-hidden bg-neutral-50/50">
            ...
            <div className="max-w-5xl mx-auto rounded-[4rem] bg-gradient-to-br from-primary-800 to-primary-900 p-12 md:p-24 text-center border border-primary-700 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-12">
                <h2 className="text-4xl md:text-7xl font-bold text-white leading-tight">
                  Start Your <br />
                  <span className="text-accent-400 italic">Legendary</span> Journey
                </h2>
                <p className="text-xl text-primary-100 max-w-2xl mx-auto font-light">
                  Join elite investors worldwide and secure your global mobility today. Our advisors are ready to guide you.
                </p>
                <div className="pt-4">
